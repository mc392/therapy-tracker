# The course-provider pitch

*The one-page approach for a counselling course lead, placement coordinator or supervisor.
Written Sept 2026 alongside `docs/institutional-partnerships-2026-09.md`, which is the plan
this supports. This is a script and a leave-behind, not a feature list.*
...
## 1. The opening (the problem, in their words)

> Every trainee on your course is keeping a record of client hours, supervision hours and the
> ratio between them. They are keeping it in whatever they were handed at induction, and by the
> time it reaches you it is forty spreadsheets in forty different states. Somebody on your staff
...
3. **What has to be signed, and by whom?** Whether a typed attestation is acceptable, or it has
   to be a wet signature on paper, changes what Stage 3 is.

---

## 2. What they get

Four things, in the order they care about them:

- **Consistent, checkable evidence.** Every trainee's hours calculated the same way, from the
  same rules, with the working shown. Not forty spreadsheets with forty different ideas of
  whether a DNA counts.
- **Problems found in November, not April.** Supervision ratio drifting, remote-work quota
  running out, a placement approval about to expire, a trainee who will not reach the minimum
  client count at their current rate. Every one of those is cheap in November and expensive in
  April.
- **Less staff time reconciling.** The tutor checks a report instead of rebuilding a total.
- **A better audit trail for your own quality assurance**, without the course becoming the
  repository for anybody's clinical notes.

And it works with **their existing forms and their existing process**. Nobody is being asked to
change how they run the course.

---

## 3. What the trainee gets (why they will actually use it)

This matters to the course lead more than it looks, because a tool trainees resent is a tool
that produces worse data than the spreadsheet did.
...
- **They also get a real practice tool** - who is booked, who owes them money, invoices and
  ...
  accurate.
- **The record is theirs, permanently.** It follows them out of the course and into practice.
...
Say it early and say it plainly, for two reasons.

The honest one: it is a limitation, and they should hear it from us.
...
**The offer in return:** run it alongside their existing process for one term, for free, with
one cohort. They keep doing exactly what they do now. At the end, compare: how many forms came
back wrong, how many needed chasing, how much staff time went on it. If it did not help, it
costs them a term of nothing.

---

## 6. What must never be said

These are not tone preferences. Each one is either untrue or would sink the partnership.
...
Two things to volunteer without being asked, because they will be the objections later:

- **When a seat lapses, the trainee keeps everything.** The training features lock; their
  records, exports and backups never do. Nobody loses their own client history because a course
  did not renew.
- **Support is a person, not a form.** An email address, answered within a day or two, and it is
  in the price.

---

## 8. Who to approach, and in what order
...
**Three conversations, then decide.** If three providers in a row say the calculation is not
theirs to approve, the institutional route as described is closed and this becomes a
trainee-direct product marketed *at* cohorts rather than *through* them. That is still a good
outcome, and four weeks is a cheap price for knowing it.
